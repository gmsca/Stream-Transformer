...
FROM
   CLAIMSTATUS_STREAM PARTITION BY CS_CLAIMSTATUSID;
...
SELECT
   ...
   AS_VALUE(CS_CLAIMSTATUSID) AS STATUSID 
FROM
   CLAIMSTATUSCLAIMLINK_STREAM PARTITION BY CS_CLAIMSTATUSID;
...
SELECT
   ...
   DESCRIPTION 
FROM
   CLAIMSTATUS_JOINED_STREAM PARTITION BY CLAIMID;
...
SELECT
   ...
   CL_PAID AS PAID 
FROM
   CLAIM_STREAM PARTITION BY CL_CLAIMID;
...
FROM
   CLAIMSTATE_STREAM PARTITION BY CB_CLAIMSTATEID;
