...
public class ClaimStatus_ClaimStatusClaimLink extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8381286900390258832L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ClaimStatus_ClaimStatusClaimLink\",\"namespace\":\"gms.cims.bridge\",\"fields\":[{\"name\":\"CL_ClaimID\",\"type\":[\"int\",\"null\"],\"default\":-1},{\"name\":\"CS_ClaimStatusID\",\"type\":[\"int\",\"null\"],\"default\":-1},{\"name\":\"CS_Description\",\"type\":[\"string\",\"null\"],\"default\":\"NONE\"}]}");
   ...
   */
  public ClaimStatus_ClaimStatusClaimLink(java.lang.Integer CL_ClaimID, java.lang.Integer CS_ClaimStatusID, java.lang.CharSequence CS_Description) {
   ...
   */
  public static gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder newBuilder() {
    return new gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder();
  }
   ...
   * @return A new ClaimStatus_ClaimStatusClaimLink RecordBuilder
   */
  public static gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder newBuilder(gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder other) {
    return new gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder(other);
  }
   ...
   * @return A new ClaimStatus_ClaimStatusClaimLink RecordBuilder
   */
  public static gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder newBuilder(gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink other) {
    return new gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ClaimStatus_ClaimStatusClaimLink>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.CL_ClaimID)) {
        this.CL_ClaimID = data().deepCopy(fields()[0].schema(), other.CL_ClaimID);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder setCLClaimID(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder clearCLClaimID() {
      CL_ClaimID = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder setCSClaimStatusID(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder clearCSClaimStatusID() {
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder setCSDescription(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public gms.cims.bridge.ClaimStatus_ClaimStatusClaimLink.Builder clearCSDescription() {
      CS_Description = null;
